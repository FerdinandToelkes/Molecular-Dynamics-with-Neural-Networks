...
"""
screen -dmS inference_xtb sh -c 'python -m ground_state_md.training_and_inference.inference_with_ase --trajectory_dir MOTOR_MD_XTB/T300_1/ -mdir epochs_1000_bs_100_lr_0.0001_flw_389830.46_elw_3937.68_seed_42 --units angstrom_kcal_per_mol_fs --md_steps 10000 --time_step 0.5 ; exec bash'
"""
...
def main(trajectory_dir: str, units: str, model_dir: str, md_steps: int, time_step: float, fold: int, seed: int, num_workers: int):
    ...
    model_dir = os.path.join(trajectory_dir, model_dir)
    ...
    xtb_target_dir = os.path.join(runs_dir_path, cfg.globals.xtb_dir_name, trajectory_dir, simulation_name)
