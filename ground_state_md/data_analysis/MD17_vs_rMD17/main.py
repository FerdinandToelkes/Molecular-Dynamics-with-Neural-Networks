...
from ground_state_md.utils import set_plotting_config, load_md17_dataset, set_data_prefix
from ground_state_md.data_analysis.MD17_vs_rMD17.molecule_analyzer import MoleculeTrajectoryComparer
...
def main(molecule_name: str, sorted: bool, show_plots: bool):
    ...
    for nr_configs_as_str in plot_config.keys():
        ...
        path_to_plot_dir = os.path.join(plot_dir, f"MD17_vs_rMD17_sorted={sorted}/{molecule_name}/{nr_configs_as_str}")
        ...
        if c["plot_distributions"]:
            plot_comparisons(
                ...
                extra_args={
                    ...
                    "total_forces": {"xlabel": r"Force Magnitude ($kcal/mol \mathrm{\AA}$)"},
        ...
        if c["plot_values"]:
            plot_comparisons(
                ...
                extra_args={
                    ...
                    "total_forces": {"ylabel": r"Force Magnitude ($\mathrm{kcal}/\mathrm{mol}\mathrm{\AA}$)"},
