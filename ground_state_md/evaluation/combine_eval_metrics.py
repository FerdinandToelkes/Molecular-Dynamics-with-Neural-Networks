...
"""
python -m ground_state_md.evaluation.combine_eval_metrics --trajectory_dir MOTOR_MD_XTB/T300_1 -mdir epochs_1_bs_100_lr_0.0001_flw_0.99_elw_0.01_seed_42 --evaluation_data test
"""
...
def parse_args() -> dict:
    ...
    parser.add_argument("-mdir", "--model_dir", type=str, default="epochs_1_bs_100_lr_0.0001_flw_0.99_elw_0.01_seed_42", help="Directory of the trained model (default: epochs_1_bs_100_lr_0.0001_flw_0.99_elw_0.01_seed_42)")
    parser.add_argument("--evaluation_data", type=str, default="test", choices=["train", "val", "test"], help="Data the model has been evaluated on (default: test)")
...
def main(trajectory_dir: str, model_dir: str, fold: int, evaluation_data: str) -> None:
    ...
    path_to_runs = os.path.join(project_root_dir, "ground_state_md/training_and_inference/runs")
    ...
    for units in unit_systems:
        ...
        metrics_file = os.path.join(target_dir, f"{evaluation_data}_metrics_fold_{fold}.csv")
    ...
    save_name = f"{evaluation_data}_metrics_{trajectory_dir}_{model_dir}_fold_{fold}"
