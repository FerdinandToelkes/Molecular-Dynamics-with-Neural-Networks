...
I also held a small presentation about my progress up to this point, which can be viewed [here](readme_images/presentation.pdf) (note that the presentation contains clickable elements, that only work if the slides are downloaded).
