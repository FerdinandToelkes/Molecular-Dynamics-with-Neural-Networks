...
def set_run_path(trajectory_dir: str, units: str, num_epochs: int, batch_size: int, learning_rate: float, seed: int) -> str:
    """ 
    ...
    run_name = f"epochs_{num_epochs}_bs_{batch_size}_lr_{learning_rate}_seed_{seed}"
...
def main(trajectory_dir: str, units: str, batch_size: int, num_epochs: int, learning_rate: float, 
         num_workers: int, config_name: str, fold: int, seed: int):
    ####################### Basic setup ###########################
