...
"""
python -m md_with_schnet.neural_net.analyze_md_ase_sim --model_dir MOTOR_MD_XTB_T300_1_epochs_1000_bs_100_lr_0.0001_seed_42_weird_units --n_samples 200
"""
...
def main(trajectory_dir: str, model_dir: str, simulation_name: str, n_samples: int, first_sample: int):
    ...
    # # compute the difference between xtb and nn energies
    # e_pot_diff = xtb_e_pot - nn_e_pot
    # e_pot_diff *= e_pot_diff
    # # plot the difference
    # set_plotting_config(fontsize=10, aspect_ratio=8/4, width_fraction=1)
    # plt.figure()
    # plt.plot(time_steps, e_pot_diff, label='Potential Energy Difference (XTB - NN)', color='purple')
    # plt.xlabel('Time [ps]')
    # plt.ylabel('Energy Difference [eV]')
    # plt.title('Potential Energy Difference Over Time')
    # plt.legend()
    # plt.tight_layout()
    # plt.show()
