...
def parse_args() -> dict:
    ...
    parser.add_argument('-au', '--atomic_units', action='store_true', help='Whether to use atomic units (default: False)')
...
def main(trajectory_dir: str, fold: int, num_atoms: int, atomic_units: bool):
    # Setup 
    ...
    if atomic_units:
        ...
        means_stds_path = os.path.join(data_prefix, trajectory_dir, f"means_stds_atomic_units_fold_{fold}.pt")
        path_to_db = os.path.join(data_prefix, trajectory_dir, "md_trajectory_atomic_units.db")
