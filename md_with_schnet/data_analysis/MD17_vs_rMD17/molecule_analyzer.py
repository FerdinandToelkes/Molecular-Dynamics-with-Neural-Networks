...
class MoleculeTrajectoryAnalyzer:
    ...
    def __init__(self, dataset: MD17, desired_batches: int, save_suffix: str, plot_dir: str = "plots"):
    ...
    def get_data(self, dataset: MD17) -> dict:
        """ Helper function to get data from a single dataset. """
        nr_atoms, symbols, positions, energies, forces = extract_data_from_MD17(dataset, self.desired_batches)
...
class MoleculeTrajectoryComparer(MoleculeTrajectoryAnalyzer):
    ...
    def __init__(self, datasets: dict, desired_batches: int, plot_dir: str = "plots"):
