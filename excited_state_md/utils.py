...
# note that this function is copied from ground_state_md/utils.py
# and had to be copied because it works with relative paths
...
def get_split_path(data_prefix: str, trajectory_dir: str, fold: int = 0) -> str:
    ...
    split_file = os.path.join(path_to_traj_dir, "splits", f"inner_splits_{fold}.npz")
