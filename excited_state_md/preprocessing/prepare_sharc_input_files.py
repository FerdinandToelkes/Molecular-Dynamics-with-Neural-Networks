...
from excited_state_md.preprocessing.prepare_tddft_data import get_property_paths
...
"""
python -m excited_state_md.preprocessing.prepare_sharc_input_files --num_atoms 48 
"""
...
def copy_info_template_to_traj_dir(path_to_traj_dir: str, initial_s0_energy: float):
    ...
    path_to_input_template = "./excited_state_md/training_and_inference/conf/input"
...
def main(target_dir: str, computed_cycles: int, num_atoms: int):
    ...
    for geo_dir in geo_dirs_with_last_excited_cycles.keys():
