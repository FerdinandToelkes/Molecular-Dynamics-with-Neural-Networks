...
"""
python -m md_with_schnet.training_and_inference.analyze_md_ase_sim --model_dir MOTOR_MD_XTB_T300_1_epochs_1000_bs_100_lr_0.0001_seed_42 --simulation_name  md_sim_steps_5000_time_step_1.0_seed_42 --n_samples 200
"""
...
def main(trajectory_dir: str, model_dir: str, simulation_name: str, n_samples: int, first_sample: int):
    ...
    md_workdir = os.path.join(home_dir, "whk/code/md_with_schnet/training_and_inference/runs", model_dir)
