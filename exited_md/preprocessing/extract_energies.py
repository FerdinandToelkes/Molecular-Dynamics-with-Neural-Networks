...
def generate_energy_csv_from_mdlog_files(data_path: str, geo_dir: str, turbomole_command: str = 'log2egy') -> str:
    """
...
def main(target_dir: str, computed_cycles: int):
    ...
    for geo_dir, _last_exited_cycle in tqdm(last_exited_cycles.items(), desc="Extracting energies"):
        # use turbomole command to extract energies from mdlog files        
        output_path = generate_energy_csv_from_mdlog_files(data_path, geo_dir, turbomole_command='log2egy')
