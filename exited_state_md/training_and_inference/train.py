...
"""
screen -dmS tddft_train sh -c 'python -m exited_state_md.training_and_inference.train --trajectory_dir PREPARE_12/spainn_datasets --units bohr_hartree_aut -e 200 -flw 0.9 -elw 0.05 -nlw 0.05 -bs 16 --nacs_key smooth_nacs ; exec bash'
"""
...
####################################################################################
def set_run_path(trajectory_dir: str, units: str, nacs_key: str, num_epochs: int, batch_size: int, learning_rate: float, 
    ...
    run_name = f"{nacs_key}_epochs_{num_epochs}_bs_{batch_size}_lr_{learning_rate}_flw_{forces_loss_weight}_elw_{energy_loss_weight}_nlw_{nacs_loss_weight}_seed_{seed}"
...
def main(trajectory_dir: str, units: str, nacs_key: str, batch_size: int, num_epochs: int, learning_rate: float, 
    ...
    # set run path
    run_path = set_run_path(trajectory_dir, units, nacs_key, num_epochs, batch_size, learning_rate, 
