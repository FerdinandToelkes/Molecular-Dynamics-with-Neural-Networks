...
"""
python -m exited_state_md.preprocessing.create_splits --trajectory_dir PREPARE_12/spainn_datasets --units bohr_hartree_aut
"""

# and for toy data (only first 3 directories):
"""
python -m exited_state_md.preprocessing.create_splits --trajectory_dir PREPARE_12/spainn_datasets/toy_data --units bohr_hartree_aut --dirs_for_training 1 --dirs_for_validation 1 --dirs_for_testing 1
"""
